...
const CampaignCard = ({ campaign }: CampaignCardProps) => {
    ...
    const lastTier = campaign.pricing.tiers[campaign.pricing.tiers.length - 1];
                ...
                <article className="card" data-id={campaign. id}>
                    ...
                    <div className="card_metaProgressContainer">
                        <div className="card_meta">
                            ...
                            <span>{lastTier?.pricePerPerson} PLN per person for a group of {campaign.people.capacity}</span>
                        </div>
